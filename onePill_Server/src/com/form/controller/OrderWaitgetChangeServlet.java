...
/**
 * Servlet implementation class OrderWaitgetChangeServlet
 */
@WebServlet("/buyer/order/waitget")
public class OrderWaitgetChangeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OrderWaitgetChangeServlet() {
        super();
