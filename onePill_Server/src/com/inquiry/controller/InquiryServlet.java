...
public class InquiryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			Boolean isSuccessful = new inquiryDao().add("user_id,title,content,flag,img,time,headImg,name,phone",
					"'"+inquiry.getUserId()+"','"+inquiry.getTitle()+"','"+inquiry.getContent()+"','"+inquiry.getFlag()+"','"+
			location+"','"+inquiry.getTime()+"','"+inquiry.getHeadImg()+"','"+inquiry.getName()+"','"+inquiry.getPhone()+"'");
